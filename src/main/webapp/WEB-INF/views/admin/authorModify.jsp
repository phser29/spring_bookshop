...
<body>
                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
                    	<form id="modifyForm" action="/admin/authorModify.do" method="post">
	                   		...
	                   		<div class="form_section">
	                   			...
	                   			<div class="form_section_content">
	                   				<textarea name="authorIntro" ><c:out value='${authorInfo.authorIntro }'></c:out></textarea>
...
<script type="text/javascript" src="../resource/js/amin/authorModify.js"></script>
</body>
</html>